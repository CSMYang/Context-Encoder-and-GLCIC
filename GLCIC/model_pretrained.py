"""
This file contains the model that has the same structure as the pre-trained weights so that we can load those weights.
Architecture taken from: https://github.com/otenim/GLCIC-PyTorch/blob/master/models.py
"""
